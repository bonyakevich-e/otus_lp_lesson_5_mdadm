OTUS Linux Professional Lesson #5 | Subject: MDADM
...
Здесь стоит обратить внимание на set-A и set-B. Может показаться что было создан RAID0 c двумя парами RAID1, в которых по 3 диска. На самом деле set-A и set-B это
не пары RAID1, это просто пометка дисков "правый/левый" в паре. То есть в случае RAID10 c 6 дисками мы имеем RAID 0 с тремя RAID1 (в каждом RAID1 по два диска). 
